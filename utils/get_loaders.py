...
def get_sampling_probabilities(class_count, mode='instance', ep=None, n_eps=None):
    ...
    print("relative_freq:",relative_freq)
...
def get_combo_loader(loader, sampling1='instance',sampling2='class'):

 
    loader1 = modify_loader(loader, mode=sampling1)

    loader2 = modify_loader(loader, mode=sampling2) #original sampling
    #balanced_loader = modify_loader(loader, mode='instance')
