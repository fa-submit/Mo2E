...
parser.add_argument('--csv_train', type=str, default='../eyepac/train_eyepacs.csv', help='path to training data csv')
parser.add_argument('--data_path', type=str, default='../eyepac/eyepacs_all_ims/', help='path data')
parser.add_argument('--sampling1', type=str, default='instance', help='sampling mode (instance, class)')
parser.add_argument('--sampling2', type=str, default='class', help='sampling mode (instance, class)')
...
parser.add_argument('--patience', type=int, default=4, help='patience before lr reduction')
...
parser.add_argument('--n_checkpoints', type=int, default=3, help='nr of best checkpoints to keep (defaults to 3)')
...
def train_model(model, sampling1, sampling2, optimizer, train_criterion, val_criterion, do_mixup, train_loader, val_loader,
    ...
    for epoch in range(n_epochs):
        ...
        # Modify sampling
        combo_loader = get_combo_loader(train_loader, sampling1=sampling1, sampling2=sampling2)
        # train one epoch
...
if __name__ == '__main__':
    ...
    tr_mccs, vl_mccs, tr_ks, vl_ks, tr_ls, vl_ls, b_epoch = train_model(model, sampling1,sampling2, optimizer, train_criterion, val_criterion,
